...
import config
from YummiMusic import Carbon, YouTube, app
from YummiMusic.core.call import Yummi
from YummiMusic.misc import db
from YummiMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from YummiMusic.utils.exceptions import AssistantErr
from YummiMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from YummiMusic.utils.inline.playlist import close_markup
from YummiMusic.utils.pastebin import Yummibin
from YummiMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Yummi.force_stop_stream(chat_id)
