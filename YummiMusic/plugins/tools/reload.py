...
from YummiMusic.utils.database import get_authuser_names, get_cmode
from YummiMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from YummiMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Yummi.stop_stream(message.chat.id)
    except:
        pass
